         ...
         >
            {
                ...
                <span className="absolute flex items-center justify-center text-white w-full h-full transition-all duration-300 transform group-hover:translate-x-full ease">
                    {text}
                </span>
